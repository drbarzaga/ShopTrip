...
export function DashboardStatsCards({
  ...
  return (
    <div className="grid gap-4 grid-cols-2 md:grid-cols-2 lg:grid-cols-4 mb-8 [&>*]:min-w-0">
      {/* Total Gastado */}
      <Card className="group cursor-default transition-all duration-300 hover:shadow-md hover:-translate-y-0.5 active:shadow-md active:-translate-y-0.5 active:scale-[0.98] [&_*]:cursor-default [&_*]:pointer-events-none select-none">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 p-4 sm:p-6">
          <CardTitle className="text-xs sm:text-sm font-medium min-w-0 flex-1">
            Total Gastado
          </CardTitle>
          <DollarSign className="h-3 w-3 sm:h-4 sm:w-4 text-primary transition-all duration-300 group-hover:scale-110 group-hover:rotate-3 group-active:scale-110 group-active:rotate-3 shrink-0 ml-2" />
        </CardHeader>
